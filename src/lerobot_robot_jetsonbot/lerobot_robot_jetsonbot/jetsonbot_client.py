...
class JetsonBotClient(Robot):
    config_class = JetsonBotClientConfig
    name = "jetsonbot_client"

    def __init__(self, config: JetsonBotClientConfig):
        import zmq
    ...
    def connect(self) -> None:
        ...
        if self.zmq_observation_socket not in socks or socks[self.zmq_observation_socket] != zmq.POLLIN:
            raise DeviceNotConnectedError("Timeout waiting for JetsonBot Host to connect expired.")
    ...
    def send_action(self, action: RobotAction) -> RobotAction:
        """Command JetsonBot to move to a target joint configuration. Translates to motor space + sends over ZMQ
